...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16909 = 0;while(true){
if((i_16909 < arr.length))
{(arr[i_16909] = null);
{
...
{var i_16916 = (self__.level + 1);while(true){
if((i_16916 <= (new_level + 1)))
{(update[i_16916] = self__.header);
{
var G__16917 = (i_16916 + 1);
i_16916 = G__16917;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16918 = 0;while(true){
if((i_16918 <= self__.level))
{var links_16919 = (update[i_16918]).forward;if(((links_16919[i_16918]) === x__$1))
{(links_16919[i_16918] = (x__$1.forward[i_16918]));
{
var G__16920 = (i_16918 + 1);
i_16918 = G__16920;
continue;
}
} else
{{
var G__16921 = (i_16918 + 1);
i_16918 = G__16921;
continue;
}
}
