...
sablono.util.ToString = (function (){var obj36849 = {};return obj36849;
})();
...
sablono.util.ToURI = (function (){var obj36851 = {};return obj36851;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__36852){
var xs = cljs.core.seq(arglist__36852);
...
{var vec__36854 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__36854,0,null);var words = cljs.core.nthnext.call(null,vec__36854,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
*/
sablono.util.camel_case_keys = (function camel_case_keys(m){var f = (function (p__36857){var vec__36858 = p__36857;var k = cljs.core.nth.call(null,vec__36858,0,null);var v = cljs.core.nth.call(null,vec__36858,1,null);if((k instanceof cljs.core.Keyword))
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__36859_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__36859_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__36859_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__36859_SHARP_))
{return p1__36859_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__36860){
var maps = cljs.core.seq(arglist__36860);
...
*/
sablono.util.normalize_element = (function normalize_element(p__36865){var vec__36868 = p__36865;var tag = cljs.core.nth.call(null,vec__36868,0,null);var content = cljs.core.nthnext.call(null,vec__36868,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__36869 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__36869,0,null);var id = cljs.core.nth.call(null,vec__36869,1,null);var class$ = cljs.core.nth.call(null,vec__36869,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
