...
sablono.util.ToString = (function (){var obj13762 = {};return obj13762;
})();
...
sablono.util.ToURI = (function (){var obj13764 = {};return obj13764;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__13765){
var xs = cljs.core.seq(arglist__13765);
...
{var vec__13767 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__13767,0,null);var words = cljs.core.nthnext.call(null,vec__13767,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
*/
sablono.util.camel_case_keys = (function camel_case_keys(m){var f = (function (p__13770){var vec__13771 = p__13770;var k = cljs.core.nth.call(null,vec__13771,0,null);var v = cljs.core.nth.call(null,vec__13771,1,null);if((k instanceof cljs.core.Keyword))
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__13772_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__13772_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__13772_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__13772_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__13773){
var maps = cljs.core.seq(arglist__13773);
...
*/
sablono.util.normalize_element = (function normalize_element(p__13778){var vec__13781 = p__13778;var tag = cljs.core.nth.call(null,vec__13781,0,null);var content = cljs.core.nthnext.call(null,vec__13781,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__13782 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__13782,0,null);var id = cljs.core.nth.call(null,vec__13782,1,null);var class$ = cljs.core.nth.call(null,vec__13782,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
