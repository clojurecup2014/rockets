...
{{
var G__36830 = cljs.core.pop.call(null,v__$1);
v__$1 = G__36830;
continue;
}
} else
...
{var pred__36834 = cljs.core._EQ_;var expr__36835 = limit;if(cljs.core.truth_(pred__36834.call(null,1,expr__36835)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__36834.call(null,2,expr__36835)))
...
var G__36837 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__36838 = (limit__$1 - 1);
var G__36839 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__36837;
limit__$1 = G__36838;
parts = G__36839;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___36841 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___36841))
{var replacement_36842 = temp__4124__auto___36841;buffer.append([cljs.core.str(replacement_36842)].join(''));
} else
{buffer.append(ch);
}
{
var G__36843 = (index + 1);
index = G__36843;
continue;
}
}
