...
{{
var G__17988 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17988;
continue;
}
} else
...
{var pred__17992 = cljs.core._EQ_;var expr__17993 = limit;if(cljs.core.truth_(pred__17992.call(null,1,expr__17993)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__17992.call(null,2,expr__17993)))
...
var G__17995 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17996 = (limit__$1 - 1);
var G__17997 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17995;
limit__$1 = G__17996;
parts = G__17997;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___17999 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___17999))
{var replacement_18000 = temp__4124__auto___17999;buffer.append([cljs.core.str(replacement_18000)].join(''));
} else
{buffer.append(ch);
}
{
var G__18001 = (index + 1);
index = G__18001;
continue;
}
}
