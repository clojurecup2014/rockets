...
{{
var G__27067 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27067;
continue;
}
} else
...
{var pred__27071 = cljs.core._EQ_;var expr__27072 = limit;if(cljs.core.truth_(pred__27071.call(null,1,expr__27072)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27071.call(null,2,expr__27072)))
...
{var ch = s.charAt(index);var temp__4124__auto___27078 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27078))
{var replacement_27079 = temp__4124__auto___27078;buffer.append([cljs.core.str(replacement_27079)].join(''));
} else
{buffer.append(ch);
}
{
