...
{{
var G__14262 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14262;
continue;
}
} else
...
{var pred__14266 = cljs.core._EQ_;var expr__14267 = limit;if(cljs.core.truth_(pred__14266.call(null,1,expr__14267)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14266.call(null,2,expr__14267)))
...
var G__14269 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14270 = (limit__$1 - 1);
var G__14271 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14269;
limit__$1 = G__14270;
parts = G__14271;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___14273 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14273))
{var replacement_14274 = temp__4124__auto___14273;buffer.append([cljs.core.str(replacement_14274)].join(''));
} else
{buffer.append(ch);
}
{
